 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param flagID numeric ID of the flag to get
 * @param optional nil or *GetFlagSnapshotsOpts - Optional Parameters:
     * @param "Limit" (optional.Int64) -  the number of snapshots to return
     * @param "Offset" (optional.Int64) -  return snapshots given the offset, it should usually set together with limit
...
func (a *FlagApiService) RestoreFlag(ctx context.Context, flagID int64) (Flag, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flags/{flagID}/restore"
	localVarPath = strings.Replace(localVarPath, "{"+"flagID"+"}", fmt.Sprintf("%v", flagID), -1)
